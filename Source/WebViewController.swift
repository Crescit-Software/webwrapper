...
open class WebViewController: UIViewController,
    ...
    */
    ...
    open var loadingIndicatorBgColor: UIColor = .black
    ...
    */
    override open func viewDidLoad() {
        ...
        setupWebView()
        setupRefreshControl()
        setupActivityIndicator(style: loadingIndicatorStyle, backgroundColor: loadingIndicatorBgColor)
        setupProgressView()
        addObservers()
    ...
    */
    ...
    open func createNewWebViewController(url: URL) -> NeemanViewController? {
        ...
        if let webViewController: WebViewController = neemanStoryboard.instantiateViewController(
            ...
            webViewController.loadingIndicatorStyle = loadingIndicatorStyle
            webViewController.loadingIndicatorBgColor = loadingIndicatorBgColor
